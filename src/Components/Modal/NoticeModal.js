            ...
            <Window>
                ...
                <Flex padding='20px'>
                    ...
                    <Subtitle size='22px' top='40px'>공지사항</Subtitle>
                        <NoticeContent>
                            <p>코로나 3단계에 대한 제한정책에 대한 제한 청책 실시에 따라 이용 시 꼭 지켜주셔야 합니다.</p><br/>
                            ...
                            <p>지침을 어기고 스터디룸을 이용하다가 피해가 발생한 경우, websolute에서는 어떠한 해결책과 책임이 없으니 공지사항들을 지켜 안전하게 스터디룸을 이용할 수 있도록 규칙 준수 바랍니다.</p>
                        </NoticeContent>
